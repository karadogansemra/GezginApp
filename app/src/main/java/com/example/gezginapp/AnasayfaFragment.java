...
public class AnasayfaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listArray.add(new ListViewModelClass(R.drawable.foto1,"Trabzon","Karadeniz"));
        listArray.add(new ListViewModelClass(R.drawable.foto2,"Mardin","Güney Doğu Anadolu"));
        listArray.add(new ListViewModelClass(R.drawable.foto3,"İzmir","Ege"));
        listArray.add(new ListViewModelClass(R.drawable.foto4,"İstanbul","Marmara"));

        CustomPostAdapter customPostAdapter = new CustomPostAdapter (getLayoutInflater(),listArray);
